            ...
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <div class="col-2 form-group">
                            <label>Giá Nhập  @if (!isset($product_detail)) <span style="color: red">*</span> @endif </label>
                            <input type="text" name="gianhap" id="gianhap" class="form-control" required maxlength="20" placeholder="Nhập giá Nhập" @isset($product_detail) value="{{ $product_detail->gianhap }}" @endisset/>
                        </div>
                        <div class="col-2 form-group">
                            <label>Giá Bán @if (!isset($product_detail)) <span style="color: red">*</span> @endif </label>
                            <input type="text" name="gia" id="gia" class="form-control" required maxlength="20" placeholder="Nhập giá Bán" @isset($product_detail) value="{{ $product_detail->gia }}" @endisset/>
                        </div>
