    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                <span class="info-box-icon bg-red"><i class="ion ion-ios-people-outline"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text">Tổng Lợi Nhuận Trong Tuần </span>
                    <span class="info-box-number">{{ number_format((new \App\Models\HoaDon())->getTotalProfit(), 0, ',', '.') }} VND<small></small></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                <span class="info-box-icon bg-red"><i class="ion ion-ios-people-outline"></i></span>
                <div class="info-box-content">
                    <span class="info-box-text">Tổng Doanh Thu Trong Tuần </span>
                    <span class="info-box-number">{{ number_format((new \App\Models\HoaDon())->getTotalDT(), 0, ',', '.') }} VND<small></small></span>
