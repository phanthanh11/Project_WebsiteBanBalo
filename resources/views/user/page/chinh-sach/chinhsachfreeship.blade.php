            ...
            <div class="col-xs-12 a-left">
                <ul class="breadcrumb">					
                    ...
                    <div class="static-contain">
                        ...
                        <p><span style="font-size:18px;"><span style="font-family:Arial,Helvetica,sans-serif;"> <strong>PVT STORE</strong> đảm bảo miễn phí vận chuyển cho mọi đơn hàng đến các Tỉnh, Thành Phố ở mọi miền Tổ Quốc</span></span></p>
                        <img class="img-responsive" style="width:600px; height: 900px" src="{{asset('assetsUser/images/phan-phoi-phu-kien-tu-bep.jpg')}}"><br>
                        <img class="img-responsive" width="1140px" src="{{asset('assetsUser/images/freeship.jpg')}}">
