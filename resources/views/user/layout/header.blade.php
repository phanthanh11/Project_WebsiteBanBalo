            ...
            <div class="rowx">
                <div class="col-lg-6 col-md-6 col-sm-6 hidden-xs top_content_">
                    <ul class="contact_top">
                        ...
                        <li class="li_contact"><span><span class="ti ti-headphone-alt"></span> Hotline: <a href="tel:0388333421">0388333421</a></span>
                        </li>
                            ...
                            <div class="row">
                                ...
                                <div class="logo_top col-lg-3 col-md-3">
                                    ...
                                    <a href="trangchu" class="logo-wrapper ">
                                        <img style="width: 200px;" src="{{ asset('images/logo-2.png') }}" alt="logo ">
                                    </a>
                                    ...
                                    <div class="header_searchs">
                                        <form action="{{route('search')}}" method="get" class="input-group search-bar" role="search">
                                            ...
                                            <span class="input-group-btn">
                                                <button class="btn icon-fallback-text" style=" background-color: #456d89;">
                                                    Tìm Kiếm
                                                </button>
                                            </span>
                                        </form>
