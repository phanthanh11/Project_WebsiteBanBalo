...
Route::group(['namespace' => 'User'], function () {
    ...
    Route::get('/dathangpaythanhcong/{maDH}/{khachhangID}/{ngaydat}/{tongtien}/{diachinhan}/{hinhthucthanhtoan}', 'DatHangController@datHangThanhCong')->name('dathangpaythanhcong');
